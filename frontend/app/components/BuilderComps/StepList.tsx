...
import PromptBox from "../LandingPageComps/PromptBox";
import StreamingStepsLoader from "../Loaders/StepsLoader";
...
export function StepsList({ steps, currentStep, onStepClick }: StepsListProps) {
  return (
    <div className="flex flex-col col-span-2 relative px-10">
      <h2 className="text-xl font-bold mb-3 text-zinc-400">Build Steps</h2>
      <div className="w-full overflow-y-scroll no-scrollbar">
        <div className="flex-1 ">
          <div className="space-y-3 h-[calc(100vh-370px)]">
            {steps.length === 0 ? (
