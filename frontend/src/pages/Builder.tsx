...
export default function Builder() {
  ...
  //     </div>
  //   );
  const { prompt } = useContext(FormContext);
  return (
    <div className="h-screen w-screen bg-gray-800 grid grid-cols-4">
      <div className=" text-xl col-span-1 ml-6 mr-6">
        <div className="py-10 w-full items-center flex flex-col">
          <div className=" h-32 w-full p-4 bg-white/5 rounded-lg text-gray-200 placeholder-white/50 border border-white/20 focus:border-white/40 focus:ring-2 focus:ring-white/20 outline-none resize-none font-medium bg-gradient-to-br from-blue-900 via-cyan-900 to-transparent ">
            {prompt}
          </div>
        </div>
      </div>
      <div className=" grid grid-cols-subgrid col-span-3 mt-[30px] ml-[100px] mr-[20px] rounded-2xl bg-gray-900">
      <div className="col-start-1 col-end-2 top-0 left-0">
